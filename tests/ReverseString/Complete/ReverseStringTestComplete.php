...
final class ReverseStringTestComplete extends TestCase
{
    ...
    {
        self::assertSame('ytrewq', ReverseStringComplete::reverse1('qwerty'));
    }

    public function testCanReverseStringWithWhitespace1(): void
    {
        self::assertSame('ytr ewq ', ReverseStringComplete::reverse1(' qwe rty'));
    }

    public function testCanReverseString2(): void
    {
        self::assertSame('ytrewq', ReverseStringComplete::reverse2('qwerty'));
    }

    public function testCanReverseStringWithWhitespace2(): void
    {
        self::assertSame('ytr ewq ', ReverseStringComplete::reverse2(' qwe rty'));
    }

    public function testCanReverseString3(): void
    {
        self::assertSame('ytrewq', ReverseStringComplete::reverse3('qwerty'));
    }

    public function testCanReverseStringWithWhitespace3(): void
    {
        self::assertSame('ytr ewq ', ReverseStringComplete::reverse3(' qwe rty'));
    }

    public function testCanReverseString4(): void
    {
        self::assertSame('ytrewq', ReverseStringComplete::reverse4('qwerty'));
    }

    public function testCanReverseStringWithWhitespace4(): void
    {
        self::assertSame('ytr ewq ', ReverseStringComplete::reverse4(' qwe rty'));
    }
}
